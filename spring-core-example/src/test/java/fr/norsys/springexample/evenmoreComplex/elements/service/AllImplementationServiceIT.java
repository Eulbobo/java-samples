 ...
 * Cette configuration permet de déterminer la configuration é utiliser pour notre test
...
public class AllImplementationServiceIT {
    ...
    /**
     * Ici on injecte automatiquement un bean entiérement chargé avec toutes les dépendances liées
