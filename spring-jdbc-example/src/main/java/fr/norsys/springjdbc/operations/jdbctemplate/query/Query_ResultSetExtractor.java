 ...
 * La logique de parcours du résultat est dans l'extractor, sa logique doit donc correspondre à celle de la requéte
 */
@Repository
public class Query_ResultSetExtractor {
    ...
    // Ci dessous, des exemples de mauvais liens potentiels entre l'extrator et la requéte

    /**
     * Récupération d'un résultat unique depuis une liste
     *
     * Le SingleUserResultSetExtractor renvoie le premier élément
     * Mais la requéte ne limite pas le nombre de résultats renvoyés
     *
    ...
    /**
     * Récupération d'une liste de résultats méme si elle ne renvoie qu'un seul élément
     *
