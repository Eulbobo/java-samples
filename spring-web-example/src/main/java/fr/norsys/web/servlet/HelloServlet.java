...
/**
 * Premiére façon de configurer une servlet : on utilise une méthode d'initialisation
 *
 * Nous avons utilisé l'annotation @Controller pour préciser le rôle de la servlet.
 * On aurait aussi bien pu indiquer @Component. Il est nécessaire de préciser qu'il s'agit un bean Spring gréce à cette
 * annotation
 *
